...
from utils import clean_data, time_series_analysis, correlation_analysis, plot_histograms
...
# Set absolute path
data_dir = "/home/besu/PycharmProjects/solar-radation-analysis/src/data/"
...
tab1, tab2, tab3 = st.tabs(["Time Series Analysis", "Correlation Analysis", "Histograms"])
